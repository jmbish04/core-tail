/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7d3e5525cd8085dd2b3e78d8f8eee1d8)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
		ASSETS: Fetcher;
		LOG_ANALYZER_AGENT: DurableObjectNamespace<import("./src/index").LogAnalyzerAgent>;
		LOG_STREAMER: DurableObjectNamespace<import("./src/index").LogStreamer>;
	}
}
